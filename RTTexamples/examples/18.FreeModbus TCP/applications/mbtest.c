/***************************2012-2013, NJUT, Edu.****************************** 
  ...
  Description:    freemodbus TCP测试  STM32F107做从机
  Version:         1.0 
  Function List:    
    1. 
    2.
...
FINSH_FUNCTION_EXPORT (test_modbus, freemodbus TCP模式 从机地址:192.168.1.30:502 e.g.:test_modbus()); 
